...
{
    public class JumpIfTrueProgram : IIntCodeProgram
    {
        private readonly IIntCodeValidator _intCodeValidator;
        private int _jump =3;

        public JumpIfTrueProgram(IIntCodeValidator intCodeValidator)
        {
        ...
        public string Process(string program, int startIndex = 0)
        {
            ...
            _intCodeValidator.ValidateProgramConfiguration(program, startIndex, 5);
